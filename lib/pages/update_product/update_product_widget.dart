                ...
                children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController1 ??=
                            ...
                            text: columnProductsRecord.name,
                          ),
                          autofocus: true,
                          obscureText: false,
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController2 ??=
                              TextEditingController(
                            text: columnProductsRecord.price.toString(),
                          ),
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          controller: _model.textController3 ??=
                              TextEditingController(
                            text: columnProductsRecord.description,
                          ),
                          autofocus: true,
                          obscureText: false,
                          decoration: InputDecoration(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          await widget.product!.update(createProductsRecordData(
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'Successfully Updated Product \"${_model.textController1.text}\" ',
                                style: TextStyle(
